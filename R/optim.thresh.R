# function to define optimal thresholds for creating binary distributions from continuous data

#obs is the observed values ... 0 for absence & 1 for presence
#pred are predicted probabilities from 0 to 1
#threshold an integer value >1, representing the number of equal interval threshold values between 0 & 1
